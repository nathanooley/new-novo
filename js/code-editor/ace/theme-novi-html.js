...
.ace-novi-html .ace_search_field {\
  border: 1px solid transparent;\
  float:left;\
}\
.ace-novi-html .ace_searchbtn{\
border: 1px solid transparent;\
float:left;\
height:20px;\
line-height:22px;\
}\
.ace-novi-html .ace_searchbtn.prev{\
...
.ace-novi-html .ace_searchbtn.prev:after{\
border:none;\
}\
.ace-novi-html .ace_searchbtn.next{\
...
.ace-novi-html .ace_searchbtn.next:after{\
border: none;\
}\
.ace-novi-html .ace_searchbtn:last-child{\
