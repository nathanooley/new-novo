...
\
.ace-novi-javascript .ace_search_field {\
  border: 1px solid transparent;\
  float:left;\
}\
\
.ace-novi-javascript .ace_searchbtn{\
  border: 1px solid transparent;\
  float:left;\
  height:20px;\
  line-height:22px;\
...
\
.ace-novi-javascript .ace_searchbtn.prev{\
...
\
.ace-novi-javascript .ace_searchbtn.prev:after{\
border:none;\
}\
.ace-novi-javascript .ace_searchbtn.next{\
...
.ace-novi-javascript .ace_searchbtn.next:after{\
 border: none;\
}\
.ace-novi-javascript .ace_searchbtn:last-child{\
